...
## 🎨 UI/UX - Componentes e Estilos

- **Shadcn/ui** - Biblioteca de componentes acessíveis construída sobre Radix UI
- **Tailwind CSS** - Utility-first styling
- **Radix UI** - Primitivos acessíveis (dialogs, menus, tabs, etc)
- **Lucide Icons** - Ícones modernos e limpos
- **Responsivo** - Funciona em mobile, tablet e desktop
- **Dark Mode** - Suporte a modo escuro (via next-themes)


## 🧪 Testes

No momento o projeto não possui testes automatizados. Contribuições para adicionar testes são bem-vindas!

Suggested: Jest (backend), Vitest (frontend), Cypress (E2E)


## 📈 Performance e Otimizações

- Code splitting automático no Vite
- Lazy loading de componentes
- Compressão gzip do servidor
- Caching de assets estáticos
- Otimização de imagens (considerar Cloudinary/S3 para produção)
...
Opções:
- **Railway** - `railway up`
- **Render** - Conectar repositório, auto-deploy
- **Heroku** - `git push heroku main`
- **AWS EC2** - Deploy manual com PM2
- **DigitalOcean** - Droplet com Docker
- **Vercel** (apenas APIs serverless)

### Frontend (React/Vite)

Opções:
- **Vercel** - Integração com Git, zero-config
- **Netlify** - Integração com Git, serverless functions
- **GitHub Pages** - Deploy estático gratuito
- **AWS S3 + CloudFront** - CDN otimizado
- **Nginx** - Em servidor próprio

### Banco de Dados

- **PostgreSQL em Produção** - Hostings: Supabase, Railway, AWS RDS, Heroku
- **Backups** - Estratégia de backup diário recomendada
- **Migrations** - `npx prisma migrate deploy` antes do deploy da aplicação
...
- Segua o estilo de código existente
...
- Entre em contato via email (adicione seu email aqui)
- Junte-se à comunidade no Discord (adicione link se houver)
...
- [ ] Integrações de pagamento (Stripe, PayPal)
...
- [ ] Sistema de affiliate/referência
- [ ] Marketing automation e email campaigns
